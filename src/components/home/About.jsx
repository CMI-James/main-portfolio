      ...
      <SectionBody>
        <div className="flex flex-col md:flex-row gap-8 md:gap-x-10 relative">
          ...
          <div className="flex-1 flex flex-col gap-y-4 sm:gap-y-6 relative">
            <h1 className="text-xl sm:text-2xl font-bold sticky top-12  bg-beige dark:bg-brown-1000 pb-2 border-b-[1px] dark:border-b-beige/30 border-b-brown-1000/30 transition-colors duration-700 text-brown-1000 dark:text-beige z-10">
