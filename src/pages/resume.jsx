// Update the imports to include useScroll and useRef
"use client";
...
const Resume = () => {
  ...
  // Create scrollYProgress using the container ref
    ...
    <Transition>
      <div ref={containerRef} className="relative">
        <Section className="theme-dark-light">
          <SectionHeader title="Resume" scrollYProgress={scrollYProgress} />
          <SectionBody>
            <div className="min-h-screen  px-4 sm:px-6 md:px-12 lg:px-24 xl:px-32">
              <motion.div
              ...
              >
                ...
                <motion.div variants={itemVariants} className="mb-12">
                  ...
                  >
                    ...
                    background in web development. Experienced in designing
                    secure systems, managing API endpoints, and integrating
                    frontend and backend components. Known for improving project
                    efficiency and enhancing user experiences. Actively
                    contributes to open source projects and manages tasks on
                    GitHub.
                  </motion.p>
                ...
                <motion.section variants={itemVariants} className="mb-12">
                  ...
                  {workExperience.map((job, index) => (
                    <motion.div
                      ...
                      variants={itemVariants}
                      className={
                        index < workExperience.length - 1 ? "mb-8" : ""
                      }
                    >
                ...
                >
                  ...
                  <motion.section variants={itemVariants}>
                    ...
                    <motion.ul className="space-y-3 text-brown-700 dark:text-beige/80 font-lora">
                      ...
                      <motion.li variants={listItemVariants}>
                        <strong>Core Skills:</strong> Responsive Design, REST
                        API Integration, Debugging & Troubleshooting, Code
